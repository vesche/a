...
AValue fn__gcc_flags(void) {
    ...
    if (a_truthy(a_eq(os, a_string("Darwin")))) {
        __ret = a_string("-lm -O2 -Wl,-stack_size,0x10000000"); goto __fn_cleanup;
    }
